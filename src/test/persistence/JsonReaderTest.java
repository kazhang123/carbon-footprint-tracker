...
public class JsonReaderTest {
    ...
    public void testParseJsonFile1() {
        try {
            List<CarbonFootprintLog> carbonLogs = JsonReader.readJson(new File("data/testJson1.json"));
    ...
    public void testJsonFile2() {
        try {
            List<CarbonFootprintLog> carbonLogs = JsonReader.readJson(new File("data/testJson2.json"));
